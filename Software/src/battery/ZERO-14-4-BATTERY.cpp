...
void setup_battery(void) {  // Performs one time setup at startup
  ...
  datalayer.battery.info.max_design_voltage_dV = 1300;  // Over this charging is not possible 114Ah x 116V
  datalayer.battery.info.min_design_voltage_dV = 1000;  // Under this discharging is disabled 114Ah x 95V
}
#endif
